...
Getting Started
Open bluetooth_serial_client.ino in the Arduino IDE.

Select your ESP32 board and correct COM port under Tools.

Upload the sketch to your ESP32 board.

Open the Arduino Serial Monitor and set the baud rate to 115200 baud.

On your smartphone or PC, turn on Bluetooth, search for ESP32-BT-Client, and pair with it.

Open your Bluetooth terminal app, connect to ESP32-BT-Client, and begin typing messages to test bi-directional data transmission.
...
<br>
<img width="973" height="385" alt="image" src="https://github.com/user-attachments/assets/53bbfe27-a5d6-441a-8d74-421503d46d03" />
<br>
